...
1. [Alpha Node](/guide/concepts/node/alpha-node) is an honorary status awarded to RSS3 Nodes that joined the RSS3 Network during the Alpha Mainnet stage from March 12 to June 3, 2024. It does not offer any special privileges.
2. [Public Good Node](/guide/concepts/node/public-good-node) donates all the proceedings to support initiatives and clauses that are oriented towards Public Goods.
