---
title: Demotion
description: Learn about demotion on VSL.
---
...
Each increase in the counter drastically reduces the Node’s [Reliability Score](./reliability-score).

When the Demotion counter reaches the threshold imposed by the Network, the Node is [slashed](./slashing).
