...
<Card title="Network Reward" href="/guide/core/concepts/fee-and-calculation/network-reward" />

A Staking Pool may be subject to the operation tax, see:

<Card title="Operation Tax" href="/guide/core/concepts/fee-and-calculation/operation-tax" />

In the event of malicious behavior by the Node, the Staking Pool is slashed, see:

<Card title="Slash Fee" href="/guide/core/concepts/fee-and-calculation/slash-fee" />
