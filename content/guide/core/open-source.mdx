...
icon: Github # @case-police-ignore Github
---
...
<Card title="Open Information Initiative" description="RSS3 proudly supports the Open Information Initiative." href="./open-information-initiative" />

Please reach out to us on [Discord](https://link.rss3.io/discord) for further information.
