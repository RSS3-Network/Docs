...
The amount of request fee, which directly reflects the work rate of a Node, has a very important impact on the final [network reward](/guide/core/vsl/reward/network-reward) received by the Node.
