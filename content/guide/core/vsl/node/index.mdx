...
1. [Normal Node](/guide/core/vsl/node/normal-node)
   - where [Alpha Node](/guide/core/vsl/node/alpha-node) is an early version of Normal Node.
2. [Public Good Node](/guide/core/vsl/node/public-good-node)
