...
The Value Sublayer (VSL) is an Ethereum Layer 2 blockchain built with a customized OP Stack using NEAR as the Data Availability layer. It is responsible for handling value derived from Open Information activities and applications, establishing a healthy ownership economy for the Network.
