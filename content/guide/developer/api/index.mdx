...
_openapi:
  toc:
    ...
    - depth: 2
      ...
      url: '#retrieve-all-compatible-networks'
    - depth: 2
      title: Retrieve Node Assets
      url: '#retrieve-node-assets'
    - depth: 2
      title: Retrieve available workers by network
      url: '#retrieve-available-workers-by-network'
    - depth: 2
      title: Retrieve config by network and worker
      url: '#retrieve-config-by-network-and-worker'
    - depth: 2
  ...
  structuredData:
    headings:
      ...
      - content: Retrieve all compatible networks
        id: retrieve-all-compatible-networks
      - content: Retrieve Node Assets
        id: retrieve-node-assets
      - content: Retrieve available workers by network
        id: retrieve-available-workers-by-network
      - content: Retrieve config by network and worker
        id: retrieve-config-by-network-and-worker
    ...
    contents:
      ...
      - content: Retrieve a list of all compatible networks.
        heading: retrieve-all-compatible-networks
      ...
      - content: Retrieve a list of available workers for a specific network.
        heading: retrieve-available-workers-by-network
      - content: >-
          Retrieve the configuration details of a specific worker on a specific
          network.
        heading: retrieve-config-by-network-and-worker
