...
The Node Status Map provides a visual representation of your RSS3 Node's operational status. This feature allows you to easily monitor and manage your Node's performance.
...
<Callout>
It's important to note that only Nodes in the `online` status are eligible for rewards. Therefore, make sure your Node is in the `online` status before the end of the epoch. Otherwise, you will not be able to receive rewards.
</Callout>
