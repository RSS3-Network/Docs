...
1. rss3_node_broadcaster: This container is used to broadcast the Node's status to Global Indexers.
1. rss3_node_monitor: This container is used to monitor worker status.
1. rss3_node_alloydb: This container is used to store data.
1. rss3_node_redis: This container is used to cache data.
1. worker containers: These containers are used to index data from their corresponding sources.
...
- `component.decentralized[].parameters`
  - Description: Additional parameters for each decentralized component
    ...
    - For Mastodon:
      - `KafkaTopic`: Kafka topic for Mastodon worker.
