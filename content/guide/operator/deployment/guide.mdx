...
#### Upgrade Process for v1.2.x or older to v2.0.x

When upgrading from v1.2.x or older versions to v2.0.x, please note that we now include a new `ai` component in this version. Update your `config.yaml` file as follows:
...
+++         network: mastodon
+++         worker: mastodon
+++         endpoint: https://your.mastodon.com/
+++         parameters:
