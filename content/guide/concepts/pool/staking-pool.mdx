...
A Staking Pool is used to store staked tokens for a Normal Node. Unless it’s a [Public Good Node](/guide/concepts/node/public-good-node), in which the rules are different.
...
<Card title="Network Reward" href="/guide/concepts/fee-and-calculation/network-reward" />

A Staking Pool may be subject to the operation tax, see:

<Card title="Operation Tax" href="/guide/concepts/fee-and-calculation/operation-tax" />

In the event of malicious behavior by the Node, the Staking Pool is slashed, see:

<Card title="Slash Fee" href="/guide/concepts/fee-and-calculation/slash-fee" />
