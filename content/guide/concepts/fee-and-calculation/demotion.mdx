...
Each increase in the counter drastically reduces the Node’s [Reliability Score](/guide/core/vsl/fee-and-calculation/reliability-score).

When the Demotion counter reaches the threshold imposed by the Network, the Node is [slashed](/guide/core/vsl/fee-and-calculation/slashing).
