...
Each increase in the counter drastically reduces the Node’s [Reliability Score](/guide/concepts/fee-and-calculation/reliability-score).

When the Demotion counter reaches the threshold imposed by the Network, the Node is [slashed](/guide/concepts/fee-and-calculation/slashing).
