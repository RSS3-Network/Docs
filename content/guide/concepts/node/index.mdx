...
The Network currently supports 2 types of Nodes:

1. [Normal Node](/guide/concepts/node/normal-node)
   - where [Alpha Node](/guide/concepts/node/alpha-node) is an early version of Normal Node.
2. [Public Good Node](/guide/concepts/node/public-good-node)
