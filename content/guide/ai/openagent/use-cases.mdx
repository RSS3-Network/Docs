...
<Card title="Chainlit" description="Learn how to interact with OpenAgent via Chainlit." href="/guide/ai/openagent/deployment/chainlit" />

Learn how to interact with OpenAgent via Chainlit.

However, you may also use OpenAgent programmatically.

<Card title="Integrate OpenAgent with App" description="Learn how to integrate OpenAgent with any App." href="/guide/ai/openagent/integrations/app" />
